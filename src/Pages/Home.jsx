          ...
          <div className="grid grid-cols-2 gap-30">
            ...
            <div className="flex flex-col justify-center gap-6">
              ...
              <p>
                ...
                fornecer cuidados de alta qualidade e personalizados.
                Acreditamos que todos merecem ter acesso a cuidados de saúde de
                qualidade, independentemente de onde vivam ou quaisquer outras
                limitações. Desenvolvemos a nossa plataforma para tornar a
                procura e a contratação de profissionais de saúde o mais fácil
                possível. Através da nossa plataforma, pacientes e familiares
                podem pesquisar e escolher enfermeiros e cuidadores
                qualificados, com base em suas necessidades específicas e
                preferências.
              </p>
              <p>
                ...
                qualificações necessárias e atendam aos nossos rigorosos padrões
                de segurança. Na Connect Care, estamos comprometidos em fornecer
                uma experiência excepcional aos nossos clientes e profissionais.
                Acreditamos que cada paciente merece receber cuidados de saúde
                de alta qualidade, e estamos orgulhosos de ajudar a tornar isso
                uma realidade para milhões de pessoas em todo o mundo.
              </p>
            </div>
          </div>
        </section>
              ...
              <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                ...
                <div class="mb-6 p-0">
                  <p class="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                    ...
                    casa para o posto todos os dias, além de terem profissionais
                    competentes e de qualidade o sistema tem uma grande
                    facilidade de uso. Obrigada!"
                  </p>
                </div>
              </div>
              <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                  ...
                  <div className="flex flex-row gap-3">
                    <div className="text-left flex flex-col max-w-xs">
                      ...
                      <p className="font-light max-h-16 line-clamp-2">
                        ...
                        feito isso, abriremos a possibilidade de enviar um outro
                        profissional. Caso não entrem em acordo, sugerimos que
                        as partes sigam o que tem no contrato.
                      </p>
                    </div>
                    <div className="text-left flex flex-col max-w-xs">
                      <a className="underline font-semibold" href="#">
                      ...
                      <p className="font-light max-h-16 line-clamp-2">
                        ...
                        comprovar a veracidade do currículo. Uma vez aprovadas,
                        vamos prosseguir com a sua checagem, pode levar cerca de
                        10 dias úteis.
                      </p>
                    </div>
                    <div className="text-left flex flex-col max-w-xs">
